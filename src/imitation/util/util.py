...
AUTHOR: HumanCompatibleAI/imitation
        Neset Unver Akmandor (NUA)

E-MAIL: akmandor.n@northeastern.edu

DESCRIPTION: TODO..."""Miscellaneous utility methods."""
...
def make_vec_env(
    ...
    #print("imitation::util::make_vec_env -> spec type: " + str(type(spec)))
    ...
    def make_env(i, this_seed):
        ...
        #print("imitation::util::make_vec_env::make_env -> env type: " + str(type(env)))
    ...
    #print("imitation::util::make_vec_env -> env_seeds type: " + str(type(env_seeds)))
    #print("imitation::util::make_vec_env -> env_seeds shape: " + str(env_seeds.shape))
    #print("imitation::util::make_vec_env -> env_seeds: " + str(env_seeds))

    env_fns = [functools.partial(make_env, i, s) for i, s in enumerate(env_seeds)]
    #print("imitation::util::make_vec_env -> env_fns type: " + str(type(env_fns)))
    #print("imitation::util::make_vec_env -> env_fns len: " + str(len(env_fns)))
    #print("imitation::util::make_vec_env -> env_fns 0 type: " + str(type(env_fns[0])))
...
def make_vec_env_openairos(
    ...
    def make_env(i, this_seed):
        ...
        # Init OpenAI_ROS ENV
        env = StartOpenAI_ROS_Environment(env_name, robot_id=0, max_episode_steps=max_episode_steps, data_folder_path=log_dir)
        #print("imitation::util::make_vec_env_openairos::make_env -> env type: " + str(type(env)))
    ...
    rng = np.random.RandomState(seed)
    env_seeds = rng.randint(0, (1 << 31) - 1, (n_envs,))
    #print("imitation::util::make_vec_env_openairos -> env_seeds type: " + str(type(env_seeds)))
    #print("imitation::util::make_vec_env_openairos -> env_seeds shape: " + str(env_seeds.shape))
    #print("imitation::util::make_vec_env_openairos -> env_seeds: " + str(env_seeds))

    env_fns = [functools.partial(make_env, i, s) for i, s in enumerate(env_seeds)]
    #print("imitation::util::make_vec_env_openairos -> env_fns type: " + str(type(env_fns)))
    #print("imitation::util::make_vec_env_openairos -> env_fns len: " + str(len(env_fns)))
    #print("imitation::util::make_vec_env_openairos -> env_fns 0 type: " + str(type(env_fns[0])))
